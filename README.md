...
## Analyste QA junior/intermédiaire | Tests fonctionnels, API REST et automatisation | Playwright, TypeScript, Agile/Scrum
...
**ISTQB CTFL — examen prévu été 2026.**
...
**Couverture actuelle :** authentification positive et négative, gestion du panier et parcours complet de commande.
...
- Validation fonctionnelle d'applications Web et d'intégrations API chez Win Technologie.
- Développement et validation d'endpoints REST chez Artur.Art.
- Inspection, traçabilité des non-conformités et suivi des corrections sur des éléments préfabriqués destinés au projet REM de Montréal.

## Compétences

**Tests :** tests fonctionnels, exploratoires, de régression, smoke, acceptation, cas de test, rapports d'anomalies, analyse de risque  
**API et données :** Postman, REST, JSON, Swagger/OpenAPI, SQL de base, MongoDB, MySQL, PostgreSQL  
**Automatisation :** Playwright, TypeScript, JavaScript, Page Object Model, tests data-driven  
**Outils :** Jira, Git, GitHub, GitHub Actions, Confluence, Agile, Scrum, Kanban  
**Développement complémentaire :** Node.js, Express, React, HTML, CSS
